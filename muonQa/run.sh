...
OPTION="-b --configuration json://configuration.json --aod-file AO2D_LHC24aq_pass1.root"
...
o2-analysis-muon-qa ${OPTION} | o2-analysis-event-selection ${OPTION} | o2-analysis-timestamp ${OPTION} 
# > stdout.log 2>&1
